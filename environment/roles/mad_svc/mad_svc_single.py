...
class MadSVCSingle(BaseAgent):
    ...
    def process_message(self, message):
        ...
        output_audio_files = self._generate_audio_segments(name, text_list, notes_list, notes_duration_list)
        ...
        for seg in final_segments:
            if current_index < len(notes):
                ...
                if seg == "AP":
                    ...
                    notes_duration_list.append("0.3")
                else:
                    notes_list.append("C4")  # 默认音符
                    notes_duration_list.append("0.3")
